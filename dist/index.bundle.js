...
parentElement.addEventListener('click', (e) => {
  if (e.target.matches('.lni.lni-heart')) {
    ...
    (0,_getData_js__WEBPACK_IMPORTED_MODULE_0__.postLikes)(numberId).then((result) => {
      if (result.success) {
        (0,_getData_js__WEBPACK_IMPORTED_MODULE_0__.getLikes)().then((resultLike) => {
